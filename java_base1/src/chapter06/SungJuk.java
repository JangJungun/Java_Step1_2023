...
public class SungJuk {
	...
	public static void main(String[] args) {
		...
		rec.java=Integer.parseInt(JOptionPane.showInputDialog("java점수 입력"));
		rec.oracle=Integer.parseInt(JOptionPane.showInputDialog("oracle점수 입력"));
		rec.spring=Integer.parseInt(JOptionPane.showInputDialog("spring점수 입력"));
